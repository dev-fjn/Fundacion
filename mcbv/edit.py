...
from detail import SingleObjectMixin, \
    SingleObjectTemplateResponseMixin, BaseDetailView, DetailView
...
class FormMixin(ContextMixin):
    ...
    def get_form_kwargs(self):
        ...
        if self.request.method in ('POST', 'PUT'):
            kwargs.update({'data': self.request.POST, 'files'
                          : self.request.FILES})
        return kwargs
...
class ModelFormSetMixin(FormSetMixin):
    ...
    def get_formset(self, form_class=None):
        form_class = form_class or self.formset_form_class
        kwargs = dict()
        Formset = modelformset_factory(self.formset_model,
...
class ModelFormMixin(FormMixin, SingleObjectMixin):
    ...
    def get_modelform_class(self):
        ...
        if self.modelform_class:
            ...
            elif hasattr(self, 'modelform_object') \
                and self.modelform_object is not None:
    ...
    def get_modelform_object(self, queryset=None):
        return self.get_object(queryset
                               or self.get_modelform_queryset(),
                               self.modelform_pk_url_kwarg)
...
class ProcessFormView(View):
    ...
    def post(
        ...
        **kwargs
        ...
        if (not form or form and form.is_valid()) and (not modelform
                or modelform and modelform.is_valid()) and (not formset
                or formset and formset.is_valid()):
            ...
            if isinstance(self, (UpdateView, CreateView)):
                resp = self.modelform_valid(modelform)
            return resp
        else:
            ...
            if isinstance(self, FormView):
                update(self.form_invalid(form))
            if isinstance(self, (FormSetView, ModelFormSetView)):
                update(self.formset_invalid(formset))
            if isinstance(self, (UpdateView, CreateView)):
                update(self.modelform_invalid(modelform))
...
class CreateView(SingleObjectTemplateResponseMixin, BaseCreateView):
    ...
    def get_template_names(self):
        return self._get_template_names(self.modelform_object,
                self.form_model)
    ...
    def create_get(
        ...
        **kwargs
        ...
        if self.modelform_pk_url_kwarg in self.kwargs:
            ...
            return super(CreateUpdateView, self).create_get(request,
                    *args, **kwargs)
    ...
    def create_post(
        ...
        **kwargs
        ...
        if self.modelform_pk_url_kwarg in self.kwargs:
            ...
            super(CreateUpdateView, self).create_post(request, *args,
                    **kwargs)
