...
from contenidos.models import Imagen, Video, FechaEvento
...
def calendario_eventos(month):
	...
	# buscar eventos en rango (mejor hacer una consulta que 31)
	qs = FechaEvento.objects.filter(fecha__gte=start, fecha__lte=end)
	...
	for week in weeks:
		semana = []
		for day in week:
			semana.append( (day, (v[day] if day in v else [])) )
		semanas.append(semana)
	return {'month': start.month, 'semanas': semanas }
