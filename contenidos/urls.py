...
from contenidos.views import Home, Calendario, EventoView, Libros, Documentos, BusquedaGeneral, CitasDe, CitasSobre
...
urlpatterns = patterns('',
    ...
    url(r'bibliografia/$', Libros.as_view(), {'propios': False}, name="bibliografia"),
