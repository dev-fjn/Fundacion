...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'contenidos_libro', 'idioma',
                      self.gf('django.db.models.fields.CharField')(default=u'Castellano', max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Libro.idioma'
        db.delete_column(u'contenidos_libro', 'idioma')
