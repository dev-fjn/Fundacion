...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Carrusel.titulo_es'
        db.add_column(u'contenidos_carrusel', 'titulo_es',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Carrusel.titulo_en'
        db.add_column(u'contenidos_carrusel', 'titulo_en',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Carrusel.titulo_es'
        db.delete_column(u'contenidos_carrusel', 'titulo_es')

        # Deleting field 'Carrusel.titulo_en'
        db.delete_column(u'contenidos_carrusel', 'titulo_en')
