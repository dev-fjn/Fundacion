...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Evento.imagen'
        db.alter_column(u'contenidos_evento', 'imagen', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Evento.imagen'
        raise RuntimeError("Cannot reverse this migration. 'Evento.imagen' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Evento.imagen'
        db.alter_column(u'contenidos_evento', 'imagen', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
