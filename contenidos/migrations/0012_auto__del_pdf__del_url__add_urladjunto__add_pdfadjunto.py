...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table(u'contenidos_pdf', u'contenidos_pdfadjunto')
        db.rename_table(u'contenidos_url', u'contenidos_urladjunto')

    def backwards(self, orm):
        db.rename_table(u'contenidos_pdfadjunto', u'contenidos_pdf')
        db.rename_table(u'contenidos_urladjunto', u'contenidos_url')
