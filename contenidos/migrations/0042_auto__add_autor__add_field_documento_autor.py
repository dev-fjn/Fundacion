...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Autor'
        db.create_table(u'contenidos_autor', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal(u'contenidos', ['Autor'])

        # Adding field 'Documento.autor'
        db.add_column(u'contenidos_documento', 'autor',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenidos.Autor'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Autor'
        db.delete_table(u'contenidos_autor')

        # Deleting field 'Documento.autor'
        db.delete_column(u'contenidos_documento', 'autor_id')
    ...
    models = {
        ...
        u'contenidos.documento': {
            ...
            'autor2': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'}),
