...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'contenidos_imagen', (
            ...
            ('titulo_es', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('titulo_en', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
        ...
        db.create_table(u'contenidos_video', (
            ('titulo_es', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('titulo_en', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('flv', self.gf('filebrowser.fields.FileBrowseField')(max_length=200, null=True, blank=True)),
            ('mp4', self.gf('filebrowser.fields.FileBrowseField')(max_length=200, null=True, blank=True)),
            ('titulo', self.gf('django.db.models.fields.CharField')(max_length=250)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
