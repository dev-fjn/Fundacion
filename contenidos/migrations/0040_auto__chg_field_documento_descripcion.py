...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Documento.descripcion'
        db.alter_column(u'contenidos_documento', 'descripcion', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Documento.descripcion'
        db.alter_column(u'contenidos_documento', 'descripcion', self.gf('django.db.models.fields.TextField')(default=''))
