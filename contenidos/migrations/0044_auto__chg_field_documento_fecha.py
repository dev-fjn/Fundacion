...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Documento.fecha'
        db.alter_column(u'contenidos_documento', 'fecha', self.gf('django.db.models.fields.DateField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Documento.fecha'
        raise RuntimeError("Cannot reverse this migration. 'Documento.fecha' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Documento.fecha'
        db.alter_column(u'contenidos_documento', 'fecha', self.gf('django.db.models.fields.DateField')())
