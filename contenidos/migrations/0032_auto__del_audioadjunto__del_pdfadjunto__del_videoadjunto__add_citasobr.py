...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'PdfAdjunto'
        db.delete_table(u'contenidos_pdfadjunto')

        # Deleting model 'VideoAdjunto'
        db.delete_table(u'contenidos_videoadjunto')

        # Adding model 'FicheroAdjunto'
        db.create_table(u'contenidos_ficheroadjunto', (
        ...
        db.send_create_signal(u'contenidos', ['FicheroAdjunto'])
    ...
    def backwards(self, orm):
        ...
        # Adding model 'PdfAdjunto'
        db.create_table(u'contenidos_pdfadjunto', (
            ('pdf', self.gf('filebrowser.fields.FileBrowseField')(max_length=200, null=True, blank=True)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('titulo', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('documento', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contenidos.Documento'])),
        ))
        db.send_create_signal(u'contenidos', ['PdfAdjunto'])
        ...
        # Deleting model 'FicheroAdjunto'
        db.delete_table(u'contenidos_ficheroadjunto')
