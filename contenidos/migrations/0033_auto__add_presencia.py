...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Presencia'
        db.create_table(u'contenidos_presencia', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('denominacion', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('lugar', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('url_lugar', self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True)),
        ...
        db.send_create_signal(u'contenidos', ['Presencia'])

    def backwards(self, orm):
        # Deleting model 'Presencia'
        db.delete_table(u'contenidos_presencia')
    ...
    complete_apps = ['contenidos']# -*- coding: utf-8 -*-
