...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Libro.resumen'
        db.alter_column(u'contenidos_libro', 'resumen', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Libro.precio'
        db.alter_column(u'contenidos_libro', 'precio', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Libro.resumen'
        raise RuntimeError("Cannot reverse this migration. 'Libro.resumen' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Libro.resumen'
        db.alter_column(u'contenidos_libro', 'resumen', self.gf('django.db.models.fields.TextField')())

        # User chose to not deal with backwards NULL issues for 'Libro.precio'
        raise RuntimeError("Cannot reverse this migration. 'Libro.precio' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Libro.precio'
        db.alter_column(u'contenidos_libro', 'precio', self.gf('django.db.models.fields.FloatField')())
