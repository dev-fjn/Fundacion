...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'contenidos_categoria', (
        ...
        db.send_create_signal(u'contenidos', ['Categoria'])

        # Adding unique constraint on 'Categoria', fields ['tipo', 'nombre']
        db.create_unique(u'contenidos_categoria', ['tipo', 'nombre'])

        # Deleting field 'Documento.tipo'
        db.delete_column(u'contenidos_documento', 'tipo')
    ...
    def backwards(self, orm):
        # Removing unique constraint on 'Categoria', fields ['tipo', 'nombre']
        db.delete_unique(u'contenidos_categoria', ['tipo', 'nombre'])

        # Deleting model 'Categoria'
        db.delete_table(u'contenidos_categoria')


        # User chose to not deal with backwards NULL issues for 'Documento.tipo'
        raise RuntimeError("Cannot reverse this migration. 'Documento.tipo' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Documento.tipo'
        db.add_column(u'contenidos_documento', 'tipo',
                      self.gf('django.db.models.fields.IntegerField')(),
                      keep_default=False)

        # Deleting field 'Documento.categoria'
        db.delete_column(u'contenidos_documento', 'categoria_id')


    models = {
        u'contenidos.categoria': {
            'Meta': {'unique_together': "(('tipo', 'nombre'),)", 'object_name': 'Categoria'},
